...
const projectsData: Project[] = [
  {
    title: "PoodleAI",
    description: "Built an Edge AI chatbot focused on fast, contextual AI assistance with efficient inference for resource-conscious deployments.",
    technologies: ["Edge AI", "Chatbot", "AI Applications", "LLM/SLM"],
  },
  {
    title: "Aether Agent",
    description: "Developed a distributed agentic AI application platform that handles build, package, configure, deploy, run, and management workflows for distributed agentic AI applications.",
    technologies: ["Agentic AI", "Distributed Systems", "Application Platform", "Deployment"],
    grade: "Grade: 10 (IIIT Hyderabad)"
  },
  {
...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-20">
      ...
      >
        <div className="section-kicker mx-auto">Selected build work</div>
        <h2 className="section-heading text-center">Featured Projects</h2>
        <p className="section-subtitle mx-auto text-center">
          Applied ML, Edge AI, full-stack systems, and agentic AI projects with measurable academic, research, and competition outcomes.
        </p>
